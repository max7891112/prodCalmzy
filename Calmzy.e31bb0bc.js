...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/our-service/ourService.js":[function(require,module,exports) {
"use strict";
...
},{}],"components/first-lesson/firstLesson.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var firstLesson = /*#__PURE__*/function () {
  function firstLesson() {
    _classCallCheck(this, firstLesson);
  }
  _createClass(firstLesson, [{
    key: "visibleElement",
    value: function visibleElement() {
      var wrapper = document.querySelector('.first-lesson__img-wrapper');
      var title = document.querySelector('.first-lesson__title-main');
      var btn = document.querySelector('.first-lesson__button-choice');
      var text = document.querySelector('.first-lesson__text-block');
...
var _default = new firstLesson();
exports.default = _default;
},{}],"components/process/process.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var Procces = /*#__PURE__*/function () {
  function Procces() {
    _classCallCheck(this, Procces);
  }
  _createClass(Procces, [{
    key: "visibleElement",
    value: function visibleElement() {
      var elements = document.querySelectorAll('.process__item');
      var counter = 1;
      var Visible = function Visible(arrItems) {
...
;
var _default = new Procces();
exports.default = _default;
},{}],"components/calm/calm.js":[function(require,module,exports) {
"use strict";
...
var Calm = /*#__PURE__*/function () {
  function Calm() {
    _classCallCheck(this, Calm);
  }
  _createClass(Calm, [{
    key: "visibleElement",
    value: function visibleElement() {
      var items = document.querySelectorAll('.calm__item');
      var Visible = function Visible(arrItems) {
...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"components/best-spec/BestSpec.js":[function(require,module,exports) {
"use strict";
...
var BestSpecAnimation = /*#__PURE__*/function () {
  function BestSpecAnimation() {
    _classCallCheck(this, BestSpecAnimation);
  }
  _createClass(BestSpecAnimation, [{
    key: "addInitialization",
    value: function addInitialization() {
      _gsap.default.to('.best-spec__card', {
        scrollTrigger: {
          trigger: '.our-service',
          start: 'center top'
        },
      ...
      _gsap.default.to('.card__img-container', {
        scrollTrigger: {
          trigger: '.process',
          start: 'center top'
        },
  ...
  return BestSpecAnimation;
}();
;
var _default = new BestSpecAnimation();
exports.default = _default;
},{"gsap":"node_modules/gsap/index.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js"}],"components/feedback/feedback.js":[function(require,module,exports) {
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var FeedbackSwiper = /*#__PURE__*/function () {
  function FeedbackSwiper() {
    _classCallCheck(this, FeedbackSwiper);
  }
  _createClass(FeedbackSwiper, [{
    key: "addInitialization",
    value: function addInitialization() {
...
;
var _default = new FeedbackSwiper();
exports.default = _default;
},{}],"index.js":[function(require,module,exports) {
"use strict";

var _ourService = _interopRequireDefault(require("./components/our-service/ourService.js"));
var _firstLesson = _interopRequireDefault(require("./components/first-lesson/firstLesson.js"));
var _process = _interopRequireDefault(require("./components/process/process.js"));
var _calm = _interopRequireDefault(require("./components/calm/calm.js"));
var _BestSpec = _interopRequireDefault(require("./components/best-spec/BestSpec.js"));
var _feedback = _interopRequireDefault(require("./components/feedback/feedback.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
document.addEventListener('DOMContentLoaded', function () {
  _ourService.default.addInitialization();
  _firstLesson.default.visibleElement();
  _process.default.visibleElement();
  _calm.default.visibleElement();
  _feedback.default.addInitialization();
  _BestSpec.default.addInitialization();
});
},{"./components/our-service/ourService.js":"components/our-service/ourService.js","./components/first-lesson/firstLesson.js":"components/first-lesson/firstLesson.js","./components/process/process.js":"components/process/process.js","./components/calm/calm.js":"components/calm/calm.js","./components/best-spec/BestSpec.js":"components/best-spec/BestSpec.js","./components/feedback/feedback.js":"components/feedback/feedback.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Calmzy.e31bb0bc.js.map